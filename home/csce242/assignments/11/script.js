...
const trees = [
    new Tree("Bald Cypress", "baldcypress.png", "Conifer", "1-2 feet per year", "120 ft", "600 years", "Swamps, Floodplains", "Bald Cypress is a large coniferous tree commonly found in swamps and floodplains. It is known for its unique buttressed trunk and knobby knees that protrude from the water. Bald Cypress can grow up to 120 feet tall and has a lifespan of around 600 years."),
    new Tree("Eastern Redbud", "easternredbud.png", "Deciduous", "Fast Growth", "20 ft", "60 years", "Forest understory", "Eastern Redbud is a small decidious tree. Trees typically grow 20 feet in height with a similar spread and have generally ascending branches and a rounded shape. Eastern redbud leaves are alternate, simple, broadly heart-shaped and 3-5 inches high and wide."),
    ...
    new Tree("Southern Magnolia", "southernmagnolia.png", "Evergreen", "Slow to Medium Growth", "60 ft", "80-120 years", "Wetlands, Uplands", "Southern Magnolia is an evergreen tree commonly found in wetlands and uplands. It has a slow to medium growth rate and usually reaches heights of around 60 feet. Southern Magnolia is known for its large, glossy leaves and fragrant white flowers, which bloom in late spring to early summer.")
];
